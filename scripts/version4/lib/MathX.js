...
export const MathX = {
    ...
    /**
     * Restricts value to a number between min and max (inclusive)
     * @param {number} value 
     * @param {number} min 
     * @param {number} max 
    ...
    rotate: (vector, quaternion) => {
        ...
        /**
         * Centers the center of the triangle defined by v1, v2, v3
         * @param {Vector3} v1 
         * @param {Vector3} v2 
         * @param {Vector3} v3 
         * @returns {Vector3}
        ...
        /**
         * Centers the center of the quad defined by v1, v2, v3 and v4
         * @param {Vector3} v1 
         * @param {Vector3} v2 
         * @param {Vector3} v3 
         * @param {Vector3} v4 
